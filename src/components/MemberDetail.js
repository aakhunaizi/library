...
const MemberDetail = () => {
  ...
  const borrowedBooks = books.filter(book => member.currentlyBorrowedBooks.includes(book.id));
                    ...
                    <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                            <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Membership Type</div>
                            <div className="h5 mb-0 font-weight-bold text-gray-800">{membership}</div>
                        </div>
                        <div className="col-auto">
                            <i className="fas fa-2x text-gray-300"><FaAward/></i>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <div className="row no-gutters align-items-center">
                          <div className="col mr-2">
                              <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                                  Borrowed Books</div>
                              <div className="h5 mb-0 font-weight-bold text-gray-800">{member.currentlyBorrowedBooks.length}</div>
                          </div>
                          <div className="col-auto">
                              <i className="fas fa-2x text-gray-300"><GiSecretBook/></i>
                          </div>
                      </div>
                  </div>
              </div>
                    ...
                    <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                            <div className="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Remained Allowance</div>
                            <div className="h5 mb-0 font-weight-bold text-gray-800">{allowance}</div>
                        </div>
                        <div className="col-auto">
                            <i className="fas fa-2x text-gray-300"><GiEvilBook/></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="card-body">
                    <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                            ...
                            <div className="h5 mb-0 font-weight-bold text-gray-800">{member.requestedBooks.length}</div>
                        </div>
                        <div className="col-auto">
        ...
        <div className="row">
            <div className="col-xl-4 col-lg-5" > 
                <div className="card shadow mb-4">
                    <div
                        ...
                        <h6 className="m-0 font-weight-bold text-primary">The face behind the name</h6>
                    </div>
                    <div className="card-body" style={{height: "30em"}}>
                            <img
                                src={member.image}
                                alt={member.name}
                                style={{ marginTop: "5em", height: "17.5em", width:"17.5em", 
                                borderRadius: "50%", border: "5px solid #5a5c69"}}
                            />
            ...
            <div className="col-xl-8 col-lg-7">
                <div className="card shadow mb-4">
                    <div
                        className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 className="m-0 font-weight-bold text-primary">Borrowed Books</h6>
                    </div>
                    <div className="card-body" style={{height: "30em"}}>
